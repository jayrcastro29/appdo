...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_detail" do
    assert_difference('UserDetail.count') do
      post user_details_url, params: { user_detail: { address: @user_detail.address, gender: @user_detail.gender, name: @user_detail.name } }
    end
  ...
  test "should update user_detail" do
    patch user_detail_url(@user_detail), params: { user_detail: { address: @user_detail.address, gender: @user_detail.gender, name: @user_detail.name } }
